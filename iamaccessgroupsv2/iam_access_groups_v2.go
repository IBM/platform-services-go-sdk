...
func (iamAccessGroups *IamAccessGroupsV2) CreateTemplateWithContext(ctx context.Context, createTemplateOptions *CreateTemplateOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_templates`, nil)
	if err != nil {
		return
	}
...
func (iamAccessGroups *IamAccessGroupsV2) ListTemplate(listTemplateOptions *ListTemplateOptions) (result *ListTemplatesResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.ListTemplateWithContext(context.Background(), listTemplateOptions)
}

// ListTemplateWithContext is an alternate form of the ListTemplate method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) ListTemplateWithContext(ctx context.Context, listTemplateOptions *ListTemplateOptions) (result *ListTemplatesResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(listTemplateOptions, "listTemplateOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(listTemplateOptions, "listTemplateOptions")
	if err != nil {
		return
	}
	...
	for headerName, headerValue := range listTemplateOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "ListTemplate")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	if listTemplateOptions.TransactionID != nil {
		builder.AddHeader("Transaction-Id", fmt.Sprint(*listTemplateOptions.TransactionID))
	}

	builder.AddQuery("account_id", fmt.Sprint(*listTemplateOptions.AccountID))
	if listTemplateOptions.Limit != nil {
		builder.AddQuery("limit", fmt.Sprint(*listTemplateOptions.Limit))
	}
	if listTemplateOptions.Offset != nil {
		builder.AddQuery("offset", fmt.Sprint(*listTemplateOptions.Offset))
	}
	if listTemplateOptions.Verbose != nil {
		builder.AddQuery("verbose", fmt.Sprint(*listTemplateOptions.Verbose))
	}
...
func (iamAccessGroups *IamAccessGroupsV2) CreateTemplateVersionWithContext(ctx context.Context, createTemplateVersionOptions *CreateTemplateVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_templates/{template_id}/versions`, pathParamsMap)
	if err != nil {
		return
	}
...
// GetTemplateSpecificVersion : Get Template - Specific Version
// Endpoint to get specific template version.
func (iamAccessGroups *IamAccessGroupsV2) GetTemplateSpecificVersion(getTemplateSpecificVersionOptions *GetTemplateSpecificVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.GetTemplateSpecificVersionWithContext(context.Background(), getTemplateSpecificVersionOptions)
}

// GetTemplateSpecificVersionWithContext is an alternate form of the GetTemplateSpecificVersion method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) GetTemplateSpecificVersionWithContext(ctx context.Context, getTemplateSpecificVersionOptions *GetTemplateSpecificVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(getTemplateSpecificVersionOptions, "getTemplateSpecificVersionOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(getTemplateSpecificVersionOptions, "getTemplateSpecificVersionOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"template_id": *getTemplateSpecificVersionOptions.TemplateID,
		"version_num": *getTemplateSpecificVersionOptions.VersionNum,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_templates/{template_id}/versions/{version_num}`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range getTemplateSpecificVersionOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "GetTemplateSpecificVersion")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	if getTemplateSpecificVersionOptions.TransactionID != nil {
		builder.AddHeader("Transaction-Id", fmt.Sprint(*getTemplateSpecificVersionOptions.TransactionID))
	}
...
// ReplaceTemplateVersion : Update Template Version
// Endpoint to update a template version.
func (iamAccessGroups *IamAccessGroupsV2) ReplaceTemplateVersion(replaceTemplateVersionOptions *ReplaceTemplateVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.ReplaceTemplateVersionWithContext(context.Background(), replaceTemplateVersionOptions)
}

// ReplaceTemplateVersionWithContext is an alternate form of the ReplaceTemplateVersion method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) ReplaceTemplateVersionWithContext(ctx context.Context, replaceTemplateVersionOptions *ReplaceTemplateVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(replaceTemplateVersionOptions, "replaceTemplateVersionOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(replaceTemplateVersionOptions, "replaceTemplateVersionOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"template_id": *replaceTemplateVersionOptions.TemplateID,
		"version_num": *replaceTemplateVersionOptions.VersionNum,
	}
	...
	for headerName, headerValue := range replaceTemplateVersionOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "ReplaceTemplateVersion")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	builder.AddHeader("Content-Type", "application/json")
	if replaceTemplateVersionOptions.IfMatch != nil {
		builder.AddHeader("If-Match", fmt.Sprint(*replaceTemplateVersionOptions.IfMatch))
	}
	if replaceTemplateVersionOptions.TransactionID != nil {
		builder.AddHeader("Transaction-Id", fmt.Sprint(*replaceTemplateVersionOptions.TransactionID))
	}

	body := make(map[string]interface{})
	if replaceTemplateVersionOptions.ID != nil {
		body["id"] = replaceTemplateVersionOptions.ID
	}
	if replaceTemplateVersionOptions.Name != nil {
		body["name"] = replaceTemplateVersionOptions.Name
	}
	if replaceTemplateVersionOptions.Description != nil {
		body["description"] = replaceTemplateVersionOptions.Description
	}
	if replaceTemplateVersionOptions.AccountID != nil {
		body["account_id"] = replaceTemplateVersionOptions.AccountID
	}
	if replaceTemplateVersionOptions.Version != nil {
		body["version"] = replaceTemplateVersionOptions.Version
	}
	if replaceTemplateVersionOptions.Committed != nil {
		body["committed"] = replaceTemplateVersionOptions.Committed
	}
	if replaceTemplateVersionOptions.AccessGroup != nil {
		body["access_group"] = replaceTemplateVersionOptions.AccessGroup
	}
	if replaceTemplateVersionOptions.PolicyTemplateReferences != nil {
		body["policy_template_references"] = replaceTemplateVersionOptions.PolicyTemplateReferences
	}
	if replaceTemplateVersionOptions.Href != nil {
		body["href"] = replaceTemplateVersionOptions.Href
	}
	if replaceTemplateVersionOptions.CreatedAt != nil {
		body["created_at"] = replaceTemplateVersionOptions.CreatedAt
	}
	if replaceTemplateVersionOptions.CreatedByID != nil {
		body["created_by_id"] = replaceTemplateVersionOptions.CreatedByID
	}
	if replaceTemplateVersionOptions.LastModifiedAt != nil {
		body["last_modified_at"] = replaceTemplateVersionOptions.LastModifiedAt
	}
	if replaceTemplateVersionOptions.LastModifiedByID != nil {
		body["last_modified_by_id"] = replaceTemplateVersionOptions.LastModifiedByID
	}
	_, err = builder.SetBodyContentJSON(body)
	if err != nil {
		return
...
func (iamAccessGroups *IamAccessGroupsV2) CommitTemplateWithContext(ctx context.Context, commitTemplateOptions *CommitTemplateOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_templates/{template_id}/versions/{version_num}/commit`, pathParamsMap)
	if err != nil {
		return
	}
...
// GetTemplateLatestVersion : Get Template - Latest Version
// Endpoint to Get the latest Template Version.
func (iamAccessGroups *IamAccessGroupsV2) GetTemplateLatestVersion(getTemplateLatestVersionOptions *GetTemplateLatestVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.GetTemplateLatestVersionWithContext(context.Background(), getTemplateLatestVersionOptions)
}

// GetTemplateLatestVersionWithContext is an alternate form of the GetTemplateLatestVersion method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) GetTemplateLatestVersionWithContext(ctx context.Context, getTemplateLatestVersionOptions *GetTemplateLatestVersionOptions) (result *CreateTemplateResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(getTemplateLatestVersionOptions, "getTemplateLatestVersionOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(getTemplateLatestVersionOptions, "getTemplateLatestVersionOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"template_id": *getTemplateLatestVersionOptions.TemplateID,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_templates/{template_id}`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range getTemplateLatestVersionOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "GetTemplateLatestVersion")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	if getTemplateLatestVersionOptions.TransactionID != nil {
		builder.AddHeader("Transaction-Id", fmt.Sprint(*getTemplateLatestVersionOptions.TransactionID))
	}
...
// CreateAssignTemplate : Assign Template To Account
// Endpoint to assign a template to an account/account group.
func (iamAccessGroups *IamAccessGroupsV2) CreateAssignTemplate(createAssignTemplateOptions *CreateAssignTemplateOptions) (result *TemplateCreateAssignmentResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.CreateAssignTemplateWithContext(context.Background(), createAssignTemplateOptions)
}

// CreateAssignTemplateWithContext is an alternate form of the CreateAssignTemplate method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) CreateAssignTemplateWithContext(ctx context.Context, createAssignTemplateOptions *CreateAssignTemplateOptions) (result *TemplateCreateAssignmentResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(createAssignTemplateOptions, "createAssignTemplateOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(createAssignTemplateOptions, "createAssignTemplateOptions")
	if err != nil {
		return
	}
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_assignment`, nil)
	if err != nil {
		return
	}

	for headerName, headerValue := range createAssignTemplateOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "CreateAssignTemplate")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	builder.AddHeader("Content-Type", "application/json")
	if createAssignTemplateOptions.TransactionID != nil {
		builder.AddHeader("Transaction-Id", fmt.Sprint(*createAssignTemplateOptions.TransactionID))
	}

	body := make(map[string]interface{})
	if createAssignTemplateOptions.TemplateID != nil {
		body["template_id"] = createAssignTemplateOptions.TemplateID
	}
	if createAssignTemplateOptions.TemplateVersion != nil {
		body["template_version"] = createAssignTemplateOptions.TemplateVersion
	}
	if createAssignTemplateOptions.TargetType != nil {
		body["target_type"] = createAssignTemplateOptions.TargetType
	}
	if createAssignTemplateOptions.Target != nil {
		body["target"] = createAssignTemplateOptions.Target
	}
	_, err = builder.SetBodyContentJSON(body)
	if err != nil {
		return
...
func (iamAccessGroups *IamAccessGroupsV2) ListAssignment(listAssignmentOptions *ListAssignmentOptions) (result *TemplatesListAssignmentResponse, response *core.DetailedResponse, err error) {
	return iamAccessGroups.ListAssignmentWithContext(context.Background(), listAssignmentOptions)
}

// ListAssignmentWithContext is an alternate form of the ListAssignment method which supports a Context parameter
func (iamAccessGroups *IamAccessGroupsV2) ListAssignmentWithContext(ctx context.Context, listAssignmentOptions *ListAssignmentOptions) (result *TemplatesListAssignmentResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateStruct(listAssignmentOptions, "listAssignmentOptions")
	if err != nil {
		return
	}
	...
	for headerName, headerValue := range listAssignmentOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_access_groups", "V2", "ListAssignment")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")

	if listAssignmentOptions.AccountID != nil {
		builder.AddQuery("account_id", fmt.Sprint(*listAssignmentOptions.AccountID))
	}
...
func (iamAccessGroups *IamAccessGroupsV2) GetAssignmentWithContext(ctx context.Context, getAssignmentOptions *GetAssignmentOptions) (result *GetTemplateAssignmentResponse, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = iamAccessGroups.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(iamAccessGroups.Service.Options.URL, `/v1/groups_assignment/{assignment_id}`, pathParamsMap)
	if err != nil {
		return
	}
...
// AccessActionControls : Access Action Controls component.
...
// AccessGroupActionControls : Access Group Action Controls component.
type AccessGroupActionControls struct {
	// Access Action Controls component.
	Access *AccessActionControls `json:"access,omitempty"`
}

// UnmarshalAccessGroupActionControls unmarshals an instance of AccessGroupActionControls from the specified map of raw messages.
func UnmarshalAccessGroupActionControls(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(AccessGroupActionControls)
...
type AccessGroupInput struct {
	...
	ActionControls *AccessGroupActionControls `json:"action_controls,omitempty"`
}
...
func UnmarshalAccessGroupInput(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "action_controls", &obj.ActionControls, UnmarshalAccessGroupActionControls)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))
...
// CreateAssignTemplateOptions : The CreateAssignTemplate options.
type CreateAssignTemplateOptions struct {
...
// NewCreateAssignTemplateOptions : Instantiate CreateAssignTemplateOptions
func (*IamAccessGroupsV2) NewCreateAssignTemplateOptions(templateID string, templateVersion string, targetType string, target string) *CreateAssignTemplateOptions {
	return &CreateAssignTemplateOptions{
		TemplateID: core.StringPtr(templateID),
...
// SetTemplateID : Allow user to set TemplateID
func (_options *CreateAssignTemplateOptions) SetTemplateID(templateID string) *CreateAssignTemplateOptions {
	_options.TemplateID = core.StringPtr(templateID)
	return _options
}

// SetTemplateVersion : Allow user to set TemplateVersion
func (_options *CreateAssignTemplateOptions) SetTemplateVersion(templateVersion string) *CreateAssignTemplateOptions {
	_options.TemplateVersion = core.StringPtr(templateVersion)
	return _options
}

// SetTargetType : Allow user to set TargetType
func (_options *CreateAssignTemplateOptions) SetTargetType(targetType string) *CreateAssignTemplateOptions {
	_options.TargetType = core.StringPtr(targetType)
	return _options
}

// SetTarget : Allow user to set Target
func (_options *CreateAssignTemplateOptions) SetTarget(target string) *CreateAssignTemplateOptions {
	_options.Target = core.StringPtr(target)
	return _options
}

// SetTransactionID : Allow user to set TransactionID
func (_options *CreateAssignTemplateOptions) SetTransactionID(transactionID string) *CreateAssignTemplateOptions {
	_options.TransactionID = core.StringPtr(transactionID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *CreateAssignTemplateOptions) SetHeaders(param map[string]string) *CreateAssignTemplateOptions {
	options.Headers = param
	return options
}
...
type CreateTemplateOptions struct {
	...
	PolicyTemplateReferences []PolicyTemplatesInput `json:"policy_template_references,omitempty"`
...
func (_options *CreateTemplateOptions) SetPolicyTemplateReferences(policyTemplateReferences []PolicyTemplatesInput) *CreateTemplateOptions {
...
func UnmarshalCreateTemplateResponse(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "policy_template_references", &obj.PolicyTemplateReferences, UnmarshalPolicyTemplatesInput)
	if err != nil {
		return
	}
...
// GetTemplateLatestVersionOptions : The GetTemplateLatestVersion options.
type GetTemplateLatestVersionOptions struct {
	// template id parameter.
	TemplateID *string `json:"template_id" validate:"required,ne="`
...
// NewGetTemplateLatestVersionOptions : Instantiate GetTemplateLatestVersionOptions
func (*IamAccessGroupsV2) NewGetTemplateLatestVersionOptions(templateID string) *GetTemplateLatestVersionOptions {
	return &GetTemplateLatestVersionOptions{
		TemplateID: core.StringPtr(templateID),
	}
}

// SetTemplateID : Allow user to set TemplateID
func (_options *GetTemplateLatestVersionOptions) SetTemplateID(templateID string) *GetTemplateLatestVersionOptions {
	_options.TemplateID = core.StringPtr(templateID)
	return _options
}

// SetTransactionID : Allow user to set TransactionID
func (_options *GetTemplateLatestVersionOptions) SetTransactionID(transactionID string) *GetTemplateLatestVersionOptions {
	_options.TransactionID = core.StringPtr(transactionID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *GetTemplateLatestVersionOptions) SetHeaders(param map[string]string) *GetTemplateLatestVersionOptions {
	options.Headers = param
	return options
}

// GetTemplateSpecificVersionOptions : The GetTemplateSpecificVersion options.
type GetTemplateSpecificVersionOptions struct {
	// template id parameter.
	TemplateID *string `json:"template_id" validate:"required,ne="`
...
// NewGetTemplateSpecificVersionOptions : Instantiate GetTemplateSpecificVersionOptions
func (*IamAccessGroupsV2) NewGetTemplateSpecificVersionOptions(templateID string, versionNum string) *GetTemplateSpecificVersionOptions {
	return &GetTemplateSpecificVersionOptions{
		TemplateID: core.StringPtr(templateID),
		VersionNum: core.StringPtr(versionNum),
	}
}
...
// SetTemplateID : Allow user to set TemplateID
func (_options *GetTemplateSpecificVersionOptions) SetTemplateID(templateID string) *GetTemplateSpecificVersionOptions {
	_options.TemplateID = core.StringPtr(templateID)
	return _options
}

// SetVersionNum : Allow user to set VersionNum
func (_options *GetTemplateSpecificVersionOptions) SetVersionNum(versionNum string) *GetTemplateSpecificVersionOptions {
	_options.VersionNum = core.StringPtr(versionNum)
	return _options
}

// SetTransactionID : Allow user to set TransactionID
func (_options *GetTemplateSpecificVersionOptions) SetTransactionID(transactionID string) *GetTemplateSpecificVersionOptions {
	_options.TransactionID = core.StringPtr(transactionID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *GetTemplateSpecificVersionOptions) SetHeaders(param map[string]string) *GetTemplateSpecificVersionOptions {
	options.Headers = param
	return options
}
...
// ListAssignmentOptions : The ListAssignment options.
type ListAssignmentOptions struct {
...
// NewListAssignmentOptions : Instantiate ListAssignmentOptions
func (*IamAccessGroupsV2) NewListAssignmentOptions() *ListAssignmentOptions {
	return &ListAssignmentOptions{}
}

// SetAccountID : Allow user to set AccountID
func (_options *ListAssignmentOptions) SetAccountID(accountID string) *ListAssignmentOptions {
	_options.AccountID = core.StringPtr(accountID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *ListAssignmentOptions) SetHeaders(param map[string]string) *ListAssignmentOptions {
	options.Headers = param
	return options
}
...
// ListTemplateOptions : The ListTemplate options.
...
// NewListTemplateOptions : Instantiate ListTemplateOptions
func (*IamAccessGroupsV2) NewListTemplateOptions(accountID string) *ListTemplateOptions {
	return &ListTemplateOptions{
		AccountID: core.StringPtr(accountID),
	}
}

// SetAccountID : Allow user to set AccountID
func (_options *ListTemplateOptions) SetAccountID(accountID string) *ListTemplateOptions {
	_options.AccountID = core.StringPtr(accountID)
	return _options
}

// SetTransactionID : Allow user to set TransactionID
func (_options *ListTemplateOptions) SetTransactionID(transactionID string) *ListTemplateOptions {
	_options.TransactionID = core.StringPtr(transactionID)
	return _options
}

// SetLimit : Allow user to set Limit
func (_options *ListTemplateOptions) SetLimit(limit int64) *ListTemplateOptions {
	_options.Limit = core.Int64Ptr(limit)
	return _options
}

// SetOffset : Allow user to set Offset
func (_options *ListTemplateOptions) SetOffset(offset int64) *ListTemplateOptions {
	_options.Offset = core.Int64Ptr(offset)
	return _options
}

// SetVerbose : Allow user to set Verbose
func (_options *ListTemplateOptions) SetVerbose(verbose bool) *ListTemplateOptions {
	_options.Verbose = core.BoolPtr(verbose)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *ListTemplateOptions) SetHeaders(param map[string]string) *ListTemplateOptions {
	options.Headers = param
	return options
}
...
// MembersActionControls : Member Action Controls component.
...
// ReplaceTemplateVersionOptions : The ReplaceTemplateVersion options.
type ReplaceTemplateVersionOptions struct {
	// ID of the template.
	TemplateID *string `json:"template_id" validate:"required,ne="`
...
// NewReplaceTemplateVersionOptions : Instantiate ReplaceTemplateVersionOptions
func (*IamAccessGroupsV2) NewReplaceTemplateVersionOptions(templateID string, versionNum string, ifMatch string) *ReplaceTemplateVersionOptions {
	return &ReplaceTemplateVersionOptions{
		TemplateID: core.StringPtr(templateID),
		VersionNum: core.StringPtr(versionNum),
		IfMatch: core.StringPtr(ifMatch),
	}
...
// SetTemplateID : Allow user to set TemplateID
func (_options *ReplaceTemplateVersionOptions) SetTemplateID(templateID string) *ReplaceTemplateVersionOptions {
	_options.TemplateID = core.StringPtr(templateID)
	return _options
}

// SetVersionNum : Allow user to set VersionNum
func (_options *ReplaceTemplateVersionOptions) SetVersionNum(versionNum string) *ReplaceTemplateVersionOptions {
	_options.VersionNum = core.StringPtr(versionNum)
	return _options
}

// SetIfMatch : Allow user to set IfMatch
func (_options *ReplaceTemplateVersionOptions) SetIfMatch(ifMatch string) *ReplaceTemplateVersionOptions {
	_options.IfMatch = core.StringPtr(ifMatch)
	return _options
}

// SetID : Allow user to set ID
func (_options *ReplaceTemplateVersionOptions) SetID(id string) *ReplaceTemplateVersionOptions {
	_options.ID = core.StringPtr(id)
	return _options
}

// SetName : Allow user to set Name
func (_options *ReplaceTemplateVersionOptions) SetName(name string) *ReplaceTemplateVersionOptions {
	_options.Name = core.StringPtr(name)
	return _options
}

// SetDescription : Allow user to set Description
func (_options *ReplaceTemplateVersionOptions) SetDescription(description string) *ReplaceTemplateVersionOptions {
	_options.Description = core.StringPtr(description)
	return _options
}

// SetAccountID : Allow user to set AccountID
func (_options *ReplaceTemplateVersionOptions) SetAccountID(accountID string) *ReplaceTemplateVersionOptions {
	_options.AccountID = core.StringPtr(accountID)
	return _options
}

// SetVersion : Allow user to set Version
func (_options *ReplaceTemplateVersionOptions) SetVersion(version string) *ReplaceTemplateVersionOptions {
	_options.Version = core.StringPtr(version)
	return _options
}

// SetCommitted : Allow user to set Committed
func (_options *ReplaceTemplateVersionOptions) SetCommitted(committed bool) *ReplaceTemplateVersionOptions {
	_options.Committed = core.BoolPtr(committed)
	return _options
}

// SetAccessGroup : Allow user to set AccessGroup
func (_options *ReplaceTemplateVersionOptions) SetAccessGroup(accessGroup *AccessGroupInput) *ReplaceTemplateVersionOptions {
	_options.AccessGroup = accessGroup
	return _options
}

// SetPolicyTemplateReferences : Allow user to set PolicyTemplateReferences
func (_options *ReplaceTemplateVersionOptions) SetPolicyTemplateReferences(policyTemplateReferences []PolicyTemplatesInput) *ReplaceTemplateVersionOptions {
	_options.PolicyTemplateReferences = policyTemplateReferences
	return _options
}

// SetHref : Allow user to set Href
func (_options *ReplaceTemplateVersionOptions) SetHref(href string) *ReplaceTemplateVersionOptions {
	_options.Href = core.StringPtr(href)
	return _options
}

// SetCreatedAt : Allow user to set CreatedAt
func (_options *ReplaceTemplateVersionOptions) SetCreatedAt(createdAt *strfmt.DateTime) *ReplaceTemplateVersionOptions {
	_options.CreatedAt = createdAt
	return _options
}

// SetCreatedByID : Allow user to set CreatedByID
func (_options *ReplaceTemplateVersionOptions) SetCreatedByID(createdByID string) *ReplaceTemplateVersionOptions {
	_options.CreatedByID = core.StringPtr(createdByID)
	return _options
}

// SetLastModifiedAt : Allow user to set LastModifiedAt
func (_options *ReplaceTemplateVersionOptions) SetLastModifiedAt(lastModifiedAt *strfmt.DateTime) *ReplaceTemplateVersionOptions {
	_options.LastModifiedAt = lastModifiedAt
	return _options
}

// SetLastModifiedByID : Allow user to set LastModifiedByID
func (_options *ReplaceTemplateVersionOptions) SetLastModifiedByID(lastModifiedByID string) *ReplaceTemplateVersionOptions {
	_options.LastModifiedByID = core.StringPtr(lastModifiedByID)
	return _options
}

// SetTransactionID : Allow user to set TransactionID
func (_options *ReplaceTemplateVersionOptions) SetTransactionID(transactionID string) *ReplaceTemplateVersionOptions {
	_options.TransactionID = core.StringPtr(transactionID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *ReplaceTemplateVersionOptions) SetHeaders(param map[string]string) *ReplaceTemplateVersionOptions {
	options.Headers = param
	return options
}
...
// RulesActionControls : Rules Action Controls component.
...
//
// TemplatePager can be used to simplify the use of the "ListTemplate" method.
//
...
// NewTemplatePager returns a new TemplatePager instance.
func (iamAccessGroups *IamAccessGroupsV2) NewTemplatePager(options *ListTemplateOptions) (pager *TemplatePager, err error) {
	if options.Offset != nil && *options.Offset != 0 {
		err = fmt.Errorf("the 'options.Offset' field should not be set")
		return
	}

	var optionsCopy ListTemplateOptions = *options
	pager = &TemplatePager{
		hasNext: true,
		options: &optionsCopy,
		client:  iamAccessGroups,
...
// HasNext returns true if there are potentially more results to be retrieved.
func (pager *TemplatePager) HasNext() bool {
	return pager.hasNext
}

// GetNextWithContext returns the next page of results using the specified Context.
func (pager *TemplatePager) GetNextWithContext(ctx context.Context) (page []TemplateItem, err error) {
	if !pager.HasNext() {
		return nil, fmt.Errorf("no more results available")
	}
	...
	result, _, err := pager.client.ListTemplateWithContext(ctx, pager.options)
	if err != nil {
		return
	}
...
// GetAllWithContext returns all results by invoking GetNextWithContext() repeatedly
// until all pages of results have been retrieved.
func (pager *TemplatePager) GetAllWithContext(ctx context.Context) (allItems []TemplateItem, err error) {
	for pager.HasNext() {
...
// GetNext invokes GetNextWithContext() using context.Background() as the Context parameter.
func (pager *TemplatePager) GetNext() (page []TemplateItem, err error) {
	return pager.GetNextWithContext(context.Background())
}

// GetAll invokes GetAllWithContext() using context.Background() as the Context parameter.
func (pager *TemplatePager) GetAll() (allItems []TemplateItem, err error) {
	return pager.GetAllWithContext(context.Background())
}

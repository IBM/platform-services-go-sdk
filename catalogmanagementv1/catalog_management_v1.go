...
func (catalogManagement *CatalogManagementV1) UpdateOfferingWithContext(ctx context.Context, updateOfferingOptions *UpdateOfferingOptions) (result *Offering, response *core.DetailedResponse, err error) {
	...
	if updateOfferingOptions.Updates != nil {
...
// The operation to be performed.
const (
	PatchDocumentOpAddConst = "add"
	PatchDocumentOpCopyConst = "copy"
	PatchDocumentOpMoveConst = "move"
	PatchDocumentOpRemoveConst = "remove"
	PatchDocumentOpReplaceConst = "replace"
	PatchDocumentOpTestConst = "test"
)

// NewPatchDocument : Instantiate PatchDocument (Generic Model Constructor)
func (*CatalogManagementV1) NewPatchDocument(op string, path string) (_model *PatchDocument, err error) {
...
type UpdateOfferingOptions struct {
	...
	Updates []PatchDocument `json:"updates,omitempty"`
...
func (_options *UpdateOfferingOptions) SetUpdates(updates []PatchDocument) *UpdateOfferingOptions {

...
func (resourceController *ResourceControllerV2) ListResourceInstances(listResourceInstancesOptions *ListResourceInstancesOptions) (result *ResourceInstancesList, response *core.DetailedResponse, err error) {
	...
	response, err = resourceController.Service.Request(request, make(map[string]interface{}))
	if err == nil {
...
func (resourceController *ResourceControllerV2) ListResourceKeys(listResourceKeysOptions *ListResourceKeysOptions) (result *ResourceKeysList, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceKeysList(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) CreateResourceKey(createResourceKeyOptions *CreateResourceKeyOptions) (result *ResourceKey, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceKey(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) ListResourceBindings(listResourceBindingsOptions *ListResourceBindingsOptions) (result *ResourceBindingsList, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceBindingsList(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) CreateResourceBinding(createResourceBindingOptions *CreateResourceBindingOptions) (result *ResourceBinding, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceBinding(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) ListResourceAliases(listResourceAliasesOptions *ListResourceAliasesOptions) (result *ResourceAliasesList, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceAliasesList(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) CreateResourceAlias(createResourceAliasOptions *CreateResourceAliasOptions) (result *ResourceAlias, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalResourceAlias(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) ListReclamations(listReclamationsOptions *ListReclamationsOptions) (result *ReclamationsList, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalReclamationsList(m)
		response.Result = result
	}
...
func (resourceController *ResourceControllerV2) RunReclamationAction(runReclamationActionOptions *RunReclamationActionOptions) (result *Reclamation, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalReclamation(m)
		response.Result = result
	}
...
// UnmarshalCredentials constructs an instance of Credentials from the specified map.
func UnmarshalCredentials(m map[string]interface{}) (result *Credentials, err error) {
	m = core.CopyMap(m)
	obj := new(Credentials)
	...
	delete(m, "apikey")
	obj.IamApikeyDescription, err = core.UnmarshalString(m, "iam_apikey_description")
	if err != nil {
		return
	}
	delete(m, "iam_apikey_description")
	obj.IamApikeyName, err = core.UnmarshalString(m, "iam_apikey_name")
	if err != nil {
		return
	}
	delete(m, "iam_apikey_name")
	obj.IamRoleCrn, err = core.UnmarshalString(m, "iam_role_crn")
	if err != nil {
		return
	}
	delete(m, "iam_role_crn")
	obj.IamServiceidCrn, err = core.UnmarshalString(m, "iam_serviceid_crn")
	if err != nil {
		return
	}
...
// UnmarshalCredentialsSlice unmarshals a slice of Credentials instances from the specified list of maps.
func UnmarshalCredentialsSlice(s []interface{}) (slice []Credentials, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'Credentials'")
			return
		}
		obj, e := UnmarshalCredentials(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalCredentialsAsProperty unmarshals an instance of Credentials that is stored as a property
// within the specified map.
func UnmarshalCredentialsAsProperty(m map[string]interface{}, propertyName string) (result *Credentials, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'Credentials'", propertyName)
			return
		}
		result, err = UnmarshalCredentials(objMap)
	}
	return
}

// UnmarshalCredentialsSliceAsProperty unmarshals a slice of Credentials instances that are stored as a property
// within the specified map.
func UnmarshalCredentialsSliceAsProperty(m map[string]interface{}, propertyName string) (slice []Credentials, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'Credentials'", propertyName)
			return
		}
		slice, err = UnmarshalCredentialsSlice(vSlice)
	}
	return
}
...
// UnmarshalPlanHistoryItemAsProperty unmarshals an instance of PlanHistoryItem that is stored as a property
// within the specified map.
func UnmarshalPlanHistoryItemAsProperty(m map[string]interface{}, propertyName string) (result *PlanHistoryItem, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'PlanHistoryItem'", propertyName)
			return
		}
		result, err = UnmarshalPlanHistoryItem(objMap)
	}
	return
}
...
// UnmarshalReclamation constructs an instance of Reclamation from the specified map.
func UnmarshalReclamation(m map[string]interface{}) (result *Reclamation, err error) {
	obj := new(Reclamation)
	...
	obj.EntityTypeID, err = core.UnmarshalString(m, "entity_type_id")
	if err != nil {
		return
	}
	...
	obj.ResourceInstanceID, err = core.UnmarshalAny(m, "resource_instance_id")
	if err != nil {
		return
	}
	...
	obj.PolicyID, err = core.UnmarshalString(m, "policy_id")
	if err != nil {
		return
	}
	...
	obj.TargetTime, err = core.UnmarshalString(m, "target_time")
	if err != nil {
		return
	}
	obj.CustomProperties, err = core.UnmarshalString(m, "custom_properties")
	if err != nil {
		return
	}
...
// UnmarshalReclamationSlice unmarshals a slice of Reclamation instances from the specified list of maps.
func UnmarshalReclamationSlice(s []interface{}) (slice []Reclamation, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'Reclamation'")
			return
		}
		obj, e := UnmarshalReclamation(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalReclamationAsProperty unmarshals an instance of Reclamation that is stored as a property
// within the specified map.
func UnmarshalReclamationAsProperty(m map[string]interface{}, propertyName string) (result *Reclamation, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'Reclamation'", propertyName)
			return
		}
		result, err = UnmarshalReclamation(objMap)
	}
	return
}

// UnmarshalReclamationSliceAsProperty unmarshals a slice of Reclamation instances that are stored as a property
// within the specified map.
func UnmarshalReclamationSliceAsProperty(m map[string]interface{}, propertyName string) (slice []Reclamation, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'Reclamation'", propertyName)
			return
		}
		slice, err = UnmarshalReclamationSlice(vSlice)
	}
	return
}
...
// UnmarshalReclamationsList constructs an instance of ReclamationsList from the specified map.
func UnmarshalReclamationsList(m map[string]interface{}) (result *ReclamationsList, err error) {
	obj := new(ReclamationsList)
	obj.Resources, err = UnmarshalReclamationSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalReclamationsListSlice unmarshals a slice of ReclamationsList instances from the specified list of maps.
func UnmarshalReclamationsListSlice(s []interface{}) (slice []ReclamationsList, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ReclamationsList'")
			return
		}
		obj, e := UnmarshalReclamationsList(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalReclamationsListAsProperty unmarshals an instance of ReclamationsList that is stored as a property
// within the specified map.
func UnmarshalReclamationsListAsProperty(m map[string]interface{}, propertyName string) (result *ReclamationsList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ReclamationsList'", propertyName)
			return
		}
		result, err = UnmarshalReclamationsList(objMap)
	}
	return
}

// UnmarshalReclamationsListSliceAsProperty unmarshals a slice of ReclamationsList instances that are stored as a property
// within the specified map.
func UnmarshalReclamationsListSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ReclamationsList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ReclamationsList'", propertyName)
			return
		}
		slice, err = UnmarshalReclamationsListSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceAlias constructs an instance of ResourceAlias from the specified map.
func UnmarshalResourceAlias(m map[string]interface{}) (result *ResourceAlias, err error) {
	...
	obj.RegionInstanceID, err = core.UnmarshalString(m, "region_instance_id")
	if err != nil {
		return
	}
	obj.ResourceInstanceURL, err = core.UnmarshalString(m, "resource_instance_url")
	if err != nil {
		return
	}
...
// UnmarshalResourceAliasSlice unmarshals a slice of ResourceAlias instances from the specified list of maps.
func UnmarshalResourceAliasSlice(s []interface{}) (slice []ResourceAlias, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceAlias'")
			return
		}
		obj, e := UnmarshalResourceAlias(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceAliasAsProperty unmarshals an instance of ResourceAlias that is stored as a property
// within the specified map.
func UnmarshalResourceAliasAsProperty(m map[string]interface{}, propertyName string) (result *ResourceAlias, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceAlias'", propertyName)
			return
		}
		result, err = UnmarshalResourceAlias(objMap)
	}
	return
}

// UnmarshalResourceAliasSliceAsProperty unmarshals a slice of ResourceAlias instances that are stored as a property
// within the specified map.
func UnmarshalResourceAliasSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceAlias, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceAlias'", propertyName)
			return
		}
		slice, err = UnmarshalResourceAliasSlice(vSlice)
	}
	return
}
...
type ResourceAliasesList struct {
	...
	RowsCount *float64 `json:"rows_count" validate:"required"`
}


// UnmarshalResourceAliasesList constructs an instance of ResourceAliasesList from the specified map.
func UnmarshalResourceAliasesList(m map[string]interface{}) (result *ResourceAliasesList, err error) {
	obj := new(ResourceAliasesList)
	obj.NextURL, err = core.UnmarshalString(m, "next_url")
	if err != nil {
		return
	}
	obj.Resources, err = UnmarshalResourceAliasSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
...
// UnmarshalResourceAliasesListSlice unmarshals a slice of ResourceAliasesList instances from the specified list of maps.
func UnmarshalResourceAliasesListSlice(s []interface{}) (slice []ResourceAliasesList, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceAliasesList'")
			return
		}
		obj, e := UnmarshalResourceAliasesList(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceAliasesListAsProperty unmarshals an instance of ResourceAliasesList that is stored as a property
// within the specified map.
func UnmarshalResourceAliasesListAsProperty(m map[string]interface{}, propertyName string) (result *ResourceAliasesList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceAliasesList'", propertyName)
			return
		}
		result, err = UnmarshalResourceAliasesList(objMap)
	}
	return
}

// UnmarshalResourceAliasesListSliceAsProperty unmarshals a slice of ResourceAliasesList instances that are stored as a property
// within the specified map.
func UnmarshalResourceAliasesListSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceAliasesList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceAliasesList'", propertyName)
			return
		}
		slice, err = UnmarshalResourceAliasesListSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceBinding constructs an instance of ResourceBinding from the specified map.
func UnmarshalResourceBinding(m map[string]interface{}) (result *ResourceBinding, err error) {
	...
	obj.SourceCrn, err = core.UnmarshalString(m, "source_crn")
	if err != nil {
		return
	}
	obj.TargetCrn, err = core.UnmarshalString(m, "target_crn")
	...
	obj.RegionBindingID, err = core.UnmarshalString(m, "region_binding_id")
	if err != nil {
		return
	}
	obj.State, err = core.UnmarshalString(m, "state")
	...
	obj.Credentials, err = UnmarshalCredentialsAsProperty(m, "credentials")
	if err != nil {
		return
	}
	...
	obj.ResourceAliasURL, err = core.UnmarshalString(m, "resource_alias_url")
	if err != nil {
		return
	}
	obj.CreatedAt, err = core.UnmarshalDateTime(m, "created_at")
...
// UnmarshalResourceBindingSlice unmarshals a slice of ResourceBinding instances from the specified list of maps.
func UnmarshalResourceBindingSlice(s []interface{}) (slice []ResourceBinding, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceBinding'")
			return
		}
		obj, e := UnmarshalResourceBinding(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceBindingAsProperty unmarshals an instance of ResourceBinding that is stored as a property
// within the specified map.
func UnmarshalResourceBindingAsProperty(m map[string]interface{}, propertyName string) (result *ResourceBinding, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceBinding'", propertyName)
			return
		}
		result, err = UnmarshalResourceBinding(objMap)
	}
	return
}

// UnmarshalResourceBindingSliceAsProperty unmarshals a slice of ResourceBinding instances that are stored as a property
// within the specified map.
func UnmarshalResourceBindingSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceBinding, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceBinding'", propertyName)
			return
		}
		slice, err = UnmarshalResourceBindingSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceBindingPostParameters constructs an instance of ResourceBindingPostParameters from the specified map.
func UnmarshalResourceBindingPostParameters(m map[string]interface{}) (result *ResourceBindingPostParameters, err error) {
...
// UnmarshalResourceBindingPostParametersSlice unmarshals a slice of ResourceBindingPostParameters instances from the specified list of maps.
func UnmarshalResourceBindingPostParametersSlice(s []interface{}) (slice []ResourceBindingPostParameters, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceBindingPostParameters'")
			return
		}
		obj, e := UnmarshalResourceBindingPostParameters(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceBindingPostParametersAsProperty unmarshals an instance of ResourceBindingPostParameters that is stored as a property
// within the specified map.
func UnmarshalResourceBindingPostParametersAsProperty(m map[string]interface{}, propertyName string) (result *ResourceBindingPostParameters, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceBindingPostParameters'", propertyName)
			return
		}
		result, err = UnmarshalResourceBindingPostParameters(objMap)
	}
	return
}

// UnmarshalResourceBindingPostParametersSliceAsProperty unmarshals a slice of ResourceBindingPostParameters instances that are stored as a property
// within the specified map.
func UnmarshalResourceBindingPostParametersSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceBindingPostParameters, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceBindingPostParameters'", propertyName)
			return
		}
		slice, err = UnmarshalResourceBindingPostParametersSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceBindingsList constructs an instance of ResourceBindingsList from the specified map.
func UnmarshalResourceBindingsList(m map[string]interface{}) (result *ResourceBindingsList, err error) {
	obj := new(ResourceBindingsList)
	obj.NextURL, err = core.UnmarshalString(m, "next_url")
	if err != nil {
		return
	}
	obj.Resources, err = UnmarshalResourceBindingSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	obj.RowsCount, err = core.UnmarshalFloat64(m, "rows_count")
...
// UnmarshalResourceBindingsListSlice unmarshals a slice of ResourceBindingsList instances from the specified list of maps.
func UnmarshalResourceBindingsListSlice(s []interface{}) (slice []ResourceBindingsList, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceBindingsList'")
			return
		}
		obj, e := UnmarshalResourceBindingsList(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceBindingsListAsProperty unmarshals an instance of ResourceBindingsList that is stored as a property
// within the specified map.
func UnmarshalResourceBindingsListAsProperty(m map[string]interface{}, propertyName string) (result *ResourceBindingsList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceBindingsList'", propertyName)
			return
		}
		result, err = UnmarshalResourceBindingsList(objMap)
	}
	return
}

// UnmarshalResourceBindingsListSliceAsProperty unmarshals a slice of ResourceBindingsList instances that are stored as a property
// within the specified map.
func UnmarshalResourceBindingsListSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceBindingsList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceBindingsList'", propertyName)
			return
		}
		slice, err = UnmarshalResourceBindingsListSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceInstanceAsProperty unmarshals an instance of ResourceInstance that is stored as a property
// within the specified map.
func UnmarshalResourceInstanceAsProperty(m map[string]interface{}, propertyName string) (result *ResourceInstance, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceInstance'", propertyName)
			return
		}
		result, err = UnmarshalResourceInstance(objMap)
	}
	return
}
...
// UnmarshalResourceInstancesListSlice unmarshals a slice of ResourceInstancesList instances from the specified list of maps.
func UnmarshalResourceInstancesListSlice(s []interface{}) (slice []ResourceInstancesList, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceInstancesList'")
			return
		}
		obj, e := UnmarshalResourceInstancesList(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceInstancesListAsProperty unmarshals an instance of ResourceInstancesList that is stored as a property
// within the specified map.
func UnmarshalResourceInstancesListAsProperty(m map[string]interface{}, propertyName string) (result *ResourceInstancesList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceInstancesList'", propertyName)
			return
		}
		result, err = UnmarshalResourceInstancesList(objMap)
	}
	return
}

// UnmarshalResourceInstancesListSliceAsProperty unmarshals a slice of ResourceInstancesList instances that are stored as a property
// within the specified map.
func UnmarshalResourceInstancesListSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceInstancesList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceInstancesList'", propertyName)
			return
		}
		slice, err = UnmarshalResourceInstancesListSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceKey constructs an instance of ResourceKey from the specified map.
func UnmarshalResourceKey(m map[string]interface{}) (result *ResourceKey, err error) {
	obj := new(ResourceKey)
	obj.ID, err = core.UnmarshalString(m, "id")
	if err != nil {
		return
...
// UnmarshalResourceKeySlice unmarshals a slice of ResourceKey instances from the specified list of maps.
func UnmarshalResourceKeySlice(s []interface{}) (slice []ResourceKey, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceKey'")
			return
		}
		obj, e := UnmarshalResourceKey(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceKeyAsProperty unmarshals an instance of ResourceKey that is stored as a property
// within the specified map.
func UnmarshalResourceKeyAsProperty(m map[string]interface{}, propertyName string) (result *ResourceKey, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceKey'", propertyName)
			return
		}
		result, err = UnmarshalResourceKey(objMap)
	}
	return
}

// UnmarshalResourceKeySliceAsProperty unmarshals a slice of ResourceKey instances that are stored as a property
// within the specified map.
func UnmarshalResourceKeySliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceKey, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceKey'", propertyName)
			return
		}
		slice, err = UnmarshalResourceKeySlice(vSlice)
	}
	return
}
...
// UnmarshalResourceKeyPostParameters constructs an instance of ResourceKeyPostParameters from the specified map.
func UnmarshalResourceKeyPostParameters(m map[string]interface{}) (result *ResourceKeyPostParameters, err error) {
...
// UnmarshalResourceKeyPostParametersSlice unmarshals a slice of ResourceKeyPostParameters instances from the specified list of maps.
func UnmarshalResourceKeyPostParametersSlice(s []interface{}) (slice []ResourceKeyPostParameters, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceKeyPostParameters'")
			return
		}
		obj, e := UnmarshalResourceKeyPostParameters(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceKeyPostParametersAsProperty unmarshals an instance of ResourceKeyPostParameters that is stored as a property
// within the specified map.
func UnmarshalResourceKeyPostParametersAsProperty(m map[string]interface{}, propertyName string) (result *ResourceKeyPostParameters, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceKeyPostParameters'", propertyName)
			return
		}
		result, err = UnmarshalResourceKeyPostParameters(objMap)
	}
	return
}

// UnmarshalResourceKeyPostParametersSliceAsProperty unmarshals a slice of ResourceKeyPostParameters instances that are stored as a property
// within the specified map.
func UnmarshalResourceKeyPostParametersSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceKeyPostParameters, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceKeyPostParameters'", propertyName)
			return
		}
		slice, err = UnmarshalResourceKeyPostParametersSlice(vSlice)
	}
	return
}
...
// UnmarshalResourceKeysList constructs an instance of ResourceKeysList from the specified map.
func UnmarshalResourceKeysList(m map[string]interface{}) (result *ResourceKeysList, err error) {
	obj := new(ResourceKeysList)
	obj.NextURL, err = core.UnmarshalString(m, "next_url")
	if err != nil {
		return
	}
	obj.Resources, err = UnmarshalResourceKeySliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	obj.RowsCount, err = core.UnmarshalFloat64(m, "rows_count")
...
// UnmarshalResourceKeysListSlice unmarshals a slice of ResourceKeysList instances from the specified list of maps.
func UnmarshalResourceKeysListSlice(s []interface{}) (slice []ResourceKeysList, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ResourceKeysList'")
			return
		}
		obj, e := UnmarshalResourceKeysList(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalResourceKeysListAsProperty unmarshals an instance of ResourceKeysList that is stored as a property
// within the specified map.
func UnmarshalResourceKeysListAsProperty(m map[string]interface{}, propertyName string) (result *ResourceKeysList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ResourceKeysList'", propertyName)
			return
		}
		result, err = UnmarshalResourceKeysList(objMap)
	}
	return
}

// UnmarshalResourceKeysListSliceAsProperty unmarshals a slice of ResourceKeysList instances that are stored as a property
// within the specified map.
func UnmarshalResourceKeysListSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ResourceKeysList, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ResourceKeysList'", propertyName)
			return
		}
		slice, err = UnmarshalResourceKeysListSlice(vSlice)
	}
	return
}

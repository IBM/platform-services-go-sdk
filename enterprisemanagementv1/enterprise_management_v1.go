...
func (enterpriseManagement *EnterpriseManagementV1) CreateAccountGroup(createAccountGroupOptions *CreateAccountGroupOptions) (result *CreateAccountGroupResponse, response *core.DetailedResponse, err error) {
	...
	response, err = enterpriseManagement.Service.Request(request, make(map[string]interface{}))
	if err == nil {
		...
		result, err = UnmarshalCreateAccountGroupResponse(m)
...
func (enterpriseManagement *EnterpriseManagementV1) ListAccountGroups(listAccountGroupsOptions *ListAccountGroupsOptions) (result *ListAccountGroupsResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalListAccountGroupsResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) GetAccountGroupByID(getAccountGroupByIdOptions *GetAccountGroupByIdOptions) (result *AccountGroupResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalAccountGroupResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) CreateAccount(createAccountOptions *CreateAccountOptions) (result *CreateAccountResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalCreateAccountResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) ListAccounts(listAccountsOptions *ListAccountsOptions) (result *ListAccountsResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalListAccountsResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) GetAccountByID(getAccountByIdOptions *GetAccountByIdOptions) (result *AccountResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalAccountResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) CreateEnterprise(createEnterpriseOptions *CreateEnterpriseOptions) (result *CreateEnterpriseResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalCreateEnterpriseResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) ListEnterprises(listEnterprisesOptions *ListEnterprisesOptions) (result *ListEnterprisesResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalListEnterprisesResponse(m)
		response.Result = result
	}
...
func (enterpriseManagement *EnterpriseManagementV1) GetEnterprise(getEnterpriseOptions *GetEnterpriseOptions) (result *EnterpriseResponse, response *core.DetailedResponse, err error) {
	...
	if err == nil {
		...
		result, err = UnmarshalEnterpriseResponse(m)
		response.Result = result
	}
...
// UnmarshalAccountGroupResponse constructs an instance of AccountGroupResponse from the specified map.
func UnmarshalAccountGroupResponse(m map[string]interface{}) (result *AccountGroupResponse, err error) {
	...
	obj.Parent, err = core.UnmarshalString(m, "parent")
	if err != nil {
		return
	}
	obj.EnterpriseAccountID, err = core.UnmarshalString(m, "enterprise_account_id")
	if err != nil {
		return
	}
	...
	obj.EnterprisePath, err = core.UnmarshalString(m, "enterprise_path")
	if err != nil {
		return
	}
	...
	obj.PrimaryContactIamID, err = core.UnmarshalString(m, "primary_contact_iam_id")
	if err != nil {
		return
	}
	obj.PrimaryContactEmail, err = core.UnmarshalString(m, "primary_contact_email")
	if err != nil {
		return
	}
	...
	obj.CreatedBy, err = core.UnmarshalString(m, "created_by")
	if err != nil {
		return
	}
	...
	obj.UpdatedBy, err = core.UnmarshalString(m, "updated_by")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalAccountGroupResponseSlice unmarshals a slice of AccountGroupResponse instances from the specified list of maps.
func UnmarshalAccountGroupResponseSlice(s []interface{}) (slice []AccountGroupResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'AccountGroupResponse'")
			return
		}
		obj, e := UnmarshalAccountGroupResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalAccountGroupResponseAsProperty unmarshals an instance of AccountGroupResponse that is stored as a property
// within the specified map.
func UnmarshalAccountGroupResponseAsProperty(m map[string]interface{}, propertyName string) (result *AccountGroupResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'AccountGroupResponse'", propertyName)
			return
		}
		result, err = UnmarshalAccountGroupResponse(objMap)
	}
	return
}

// UnmarshalAccountGroupResponseSliceAsProperty unmarshals a slice of AccountGroupResponse instances that are stored as a property
// within the specified map.
func UnmarshalAccountGroupResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []AccountGroupResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'AccountGroupResponse'", propertyName)
			return
		}
		slice, err = UnmarshalAccountGroupResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalAccountResponse constructs an instance of AccountResponse from the specified map.
func UnmarshalAccountResponse(m map[string]interface{}) (result *AccountResponse, err error) {
	...
	obj.OwnerIamID, err = core.UnmarshalString(m, "owner_iam_id")
	if err != nil {
		return
	}
	obj.Paid, err = core.UnmarshalBool(m, "paid")
	if err != nil {
		return
	}
	obj.OwnerEmail, err = core.UnmarshalString(m, "owner_email")
	if err != nil {
		return
	}
	obj.IsEnterpriseAccount, err = core.UnmarshalBool(m, "is_enterprise_account")
	if err != nil {
		return
	}
	obj.CreatedAt, err = core.UnmarshalString(m, "created_at")
...
// UnmarshalAccountResponseSlice unmarshals a slice of AccountResponse instances from the specified list of maps.
func UnmarshalAccountResponseSlice(s []interface{}) (slice []AccountResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'AccountResponse'")
			return
		}
		obj, e := UnmarshalAccountResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalAccountResponseAsProperty unmarshals an instance of AccountResponse that is stored as a property
// within the specified map.
func UnmarshalAccountResponseAsProperty(m map[string]interface{}, propertyName string) (result *AccountResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'AccountResponse'", propertyName)
			return
		}
		result, err = UnmarshalAccountResponse(objMap)
	}
	return
}

// UnmarshalAccountResponseSliceAsProperty unmarshals a slice of AccountResponse instances that are stored as a property
// within the specified map.
func UnmarshalAccountResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []AccountResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'AccountResponse'", propertyName)
			return
		}
		slice, err = UnmarshalAccountResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalCreateAccountGroupResponse constructs an instance of CreateAccountGroupResponse from the specified map.
func UnmarshalCreateAccountGroupResponse(m map[string]interface{}) (result *CreateAccountGroupResponse, err error) {
	obj := new(CreateAccountGroupResponse)
	obj.AccountGroupID, err = core.UnmarshalString(m, "account_group_id")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalCreateAccountGroupResponseSlice unmarshals a slice of CreateAccountGroupResponse instances from the specified list of maps.
func UnmarshalCreateAccountGroupResponseSlice(s []interface{}) (slice []CreateAccountGroupResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'CreateAccountGroupResponse'")
			return
		}
		obj, e := UnmarshalCreateAccountGroupResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalCreateAccountGroupResponseAsProperty unmarshals an instance of CreateAccountGroupResponse that is stored as a property
// within the specified map.
func UnmarshalCreateAccountGroupResponseAsProperty(m map[string]interface{}, propertyName string) (result *CreateAccountGroupResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'CreateAccountGroupResponse'", propertyName)
			return
		}
		result, err = UnmarshalCreateAccountGroupResponse(objMap)
	}
	return
}

// UnmarshalCreateAccountGroupResponseSliceAsProperty unmarshals a slice of CreateAccountGroupResponse instances that are stored as a property
// within the specified map.
func UnmarshalCreateAccountGroupResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []CreateAccountGroupResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'CreateAccountGroupResponse'", propertyName)
			return
		}
		slice, err = UnmarshalCreateAccountGroupResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalCreateAccountResponse constructs an instance of CreateAccountResponse from the specified map.
func UnmarshalCreateAccountResponse(m map[string]interface{}) (result *CreateAccountResponse, err error) {
...
// UnmarshalCreateAccountResponseSlice unmarshals a slice of CreateAccountResponse instances from the specified list of maps.
func UnmarshalCreateAccountResponseSlice(s []interface{}) (slice []CreateAccountResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'CreateAccountResponse'")
			return
		}
		obj, e := UnmarshalCreateAccountResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalCreateAccountResponseAsProperty unmarshals an instance of CreateAccountResponse that is stored as a property
// within the specified map.
func UnmarshalCreateAccountResponseAsProperty(m map[string]interface{}, propertyName string) (result *CreateAccountResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'CreateAccountResponse'", propertyName)
			return
		}
		result, err = UnmarshalCreateAccountResponse(objMap)
	}
	return
}

// UnmarshalCreateAccountResponseSliceAsProperty unmarshals a slice of CreateAccountResponse instances that are stored as a property
// within the specified map.
func UnmarshalCreateAccountResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []CreateAccountResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'CreateAccountResponse'", propertyName)
			return
		}
		slice, err = UnmarshalCreateAccountResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalCreateEnterpriseResponse constructs an instance of CreateEnterpriseResponse from the specified map.
func UnmarshalCreateEnterpriseResponse(m map[string]interface{}) (result *CreateEnterpriseResponse, err error) {
...
// UnmarshalCreateEnterpriseResponseSlice unmarshals a slice of CreateEnterpriseResponse instances from the specified list of maps.
func UnmarshalCreateEnterpriseResponseSlice(s []interface{}) (slice []CreateEnterpriseResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'CreateEnterpriseResponse'")
			return
		}
		obj, e := UnmarshalCreateEnterpriseResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalCreateEnterpriseResponseAsProperty unmarshals an instance of CreateEnterpriseResponse that is stored as a property
// within the specified map.
func UnmarshalCreateEnterpriseResponseAsProperty(m map[string]interface{}, propertyName string) (result *CreateEnterpriseResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'CreateEnterpriseResponse'", propertyName)
			return
		}
		result, err = UnmarshalCreateEnterpriseResponse(objMap)
	}
	return
}

// UnmarshalCreateEnterpriseResponseSliceAsProperty unmarshals a slice of CreateEnterpriseResponse instances that are stored as a property
// within the specified map.
func UnmarshalCreateEnterpriseResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []CreateEnterpriseResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'CreateEnterpriseResponse'", propertyName)
			return
		}
		slice, err = UnmarshalCreateEnterpriseResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalEnterpriseResponse constructs an instance of EnterpriseResponse from the specified map.
func UnmarshalEnterpriseResponse(m map[string]interface{}) (result *EnterpriseResponse, err error) {
...
// UnmarshalEnterpriseResponseSlice unmarshals a slice of EnterpriseResponse instances from the specified list of maps.
func UnmarshalEnterpriseResponseSlice(s []interface{}) (slice []EnterpriseResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'EnterpriseResponse'")
			return
		}
		obj, e := UnmarshalEnterpriseResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalEnterpriseResponseAsProperty unmarshals an instance of EnterpriseResponse that is stored as a property
// within the specified map.
func UnmarshalEnterpriseResponseAsProperty(m map[string]interface{}, propertyName string) (result *EnterpriseResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'EnterpriseResponse'", propertyName)
			return
		}
		result, err = UnmarshalEnterpriseResponse(objMap)
	}
	return
}

// UnmarshalEnterpriseResponseSliceAsProperty unmarshals a slice of EnterpriseResponse instances that are stored as a property
// within the specified map.
func UnmarshalEnterpriseResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []EnterpriseResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'EnterpriseResponse'", propertyName)
			return
		}
		slice, err = UnmarshalEnterpriseResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalListAccountGroupsResources constructs an instance of ListAccountGroupsResources from the specified map.
func UnmarshalListAccountGroupsResources(m map[string]interface{}) (result *ListAccountGroupsResources, err error) {
...
// UnmarshalListAccountGroupsResourcesSlice unmarshals a slice of ListAccountGroupsResources instances from the specified list of maps.
func UnmarshalListAccountGroupsResourcesSlice(s []interface{}) (slice []ListAccountGroupsResources, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListAccountGroupsResources'")
			return
		}
		obj, e := UnmarshalListAccountGroupsResources(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListAccountGroupsResourcesAsProperty unmarshals an instance of ListAccountGroupsResources that is stored as a property
// within the specified map.
func UnmarshalListAccountGroupsResourcesAsProperty(m map[string]interface{}, propertyName string) (result *ListAccountGroupsResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListAccountGroupsResources'", propertyName)
			return
		}
		result, err = UnmarshalListAccountGroupsResources(objMap)
	}
	return
}

// UnmarshalListAccountGroupsResourcesSliceAsProperty unmarshals a slice of ListAccountGroupsResources instances that are stored as a property
// within the specified map.
func UnmarshalListAccountGroupsResourcesSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListAccountGroupsResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListAccountGroupsResources'", propertyName)
			return
		}
		slice, err = UnmarshalListAccountGroupsResourcesSlice(vSlice)
	}
	return
}
...
// UnmarshalListAccountGroupsResponse constructs an instance of ListAccountGroupsResponse from the specified map.
func UnmarshalListAccountGroupsResponse(m map[string]interface{}) (result *ListAccountGroupsResponse, err error) {
	...
	obj.Resources, err = UnmarshalListAccountGroupsResourcesSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalListAccountGroupsResponseSlice unmarshals a slice of ListAccountGroupsResponse instances from the specified list of maps.
func UnmarshalListAccountGroupsResponseSlice(s []interface{}) (slice []ListAccountGroupsResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListAccountGroupsResponse'")
			return
		}
		obj, e := UnmarshalListAccountGroupsResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListAccountGroupsResponseAsProperty unmarshals an instance of ListAccountGroupsResponse that is stored as a property
// within the specified map.
func UnmarshalListAccountGroupsResponseAsProperty(m map[string]interface{}, propertyName string) (result *ListAccountGroupsResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListAccountGroupsResponse'", propertyName)
			return
		}
		result, err = UnmarshalListAccountGroupsResponse(objMap)
	}
	return
}

// UnmarshalListAccountGroupsResponseSliceAsProperty unmarshals a slice of ListAccountGroupsResponse instances that are stored as a property
// within the specified map.
func UnmarshalListAccountGroupsResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListAccountGroupsResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListAccountGroupsResponse'", propertyName)
			return
		}
		slice, err = UnmarshalListAccountGroupsResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalListAccountResources constructs an instance of ListAccountResources from the specified map.
func UnmarshalListAccountResources(m map[string]interface{}) (result *ListAccountResources, err error) {
...
// UnmarshalListAccountResourcesSlice unmarshals a slice of ListAccountResources instances from the specified list of maps.
func UnmarshalListAccountResourcesSlice(s []interface{}) (slice []ListAccountResources, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListAccountResources'")
			return
		}
		obj, e := UnmarshalListAccountResources(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListAccountResourcesAsProperty unmarshals an instance of ListAccountResources that is stored as a property
// within the specified map.
func UnmarshalListAccountResourcesAsProperty(m map[string]interface{}, propertyName string) (result *ListAccountResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListAccountResources'", propertyName)
			return
		}
		result, err = UnmarshalListAccountResources(objMap)
	}
	return
}

// UnmarshalListAccountResourcesSliceAsProperty unmarshals a slice of ListAccountResources instances that are stored as a property
// within the specified map.
func UnmarshalListAccountResourcesSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListAccountResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListAccountResources'", propertyName)
			return
		}
		slice, err = UnmarshalListAccountResourcesSlice(vSlice)
	}
	return
}
...
// UnmarshalListAccountsResponse constructs an instance of ListAccountsResponse from the specified map.
func UnmarshalListAccountsResponse(m map[string]interface{}) (result *ListAccountsResponse, err error) {
	...
	obj.Resources, err = UnmarshalListAccountResourcesSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalListAccountsResponseSlice unmarshals a slice of ListAccountsResponse instances from the specified list of maps.
func UnmarshalListAccountsResponseSlice(s []interface{}) (slice []ListAccountsResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListAccountsResponse'")
			return
		}
		obj, e := UnmarshalListAccountsResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListAccountsResponseAsProperty unmarshals an instance of ListAccountsResponse that is stored as a property
// within the specified map.
func UnmarshalListAccountsResponseAsProperty(m map[string]interface{}, propertyName string) (result *ListAccountsResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListAccountsResponse'", propertyName)
			return
		}
		result, err = UnmarshalListAccountsResponse(objMap)
	}
	return
}

// UnmarshalListAccountsResponseSliceAsProperty unmarshals a slice of ListAccountsResponse instances that are stored as a property
// within the specified map.
func UnmarshalListAccountsResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListAccountsResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListAccountsResponse'", propertyName)
			return
		}
		slice, err = UnmarshalListAccountsResponseSlice(vSlice)
	}
	return
}
...
// UnmarshalListEnterpriseResources constructs an instance of ListEnterpriseResources from the specified map.
func UnmarshalListEnterpriseResources(m map[string]interface{}) (result *ListEnterpriseResources, err error) {
...
// UnmarshalListEnterpriseResourcesSlice unmarshals a slice of ListEnterpriseResources instances from the specified list of maps.
func UnmarshalListEnterpriseResourcesSlice(s []interface{}) (slice []ListEnterpriseResources, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListEnterpriseResources'")
			return
		}
		obj, e := UnmarshalListEnterpriseResources(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListEnterpriseResourcesAsProperty unmarshals an instance of ListEnterpriseResources that is stored as a property
// within the specified map.
func UnmarshalListEnterpriseResourcesAsProperty(m map[string]interface{}, propertyName string) (result *ListEnterpriseResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListEnterpriseResources'", propertyName)
			return
		}
		result, err = UnmarshalListEnterpriseResources(objMap)
	}
	return
}

// UnmarshalListEnterpriseResourcesSliceAsProperty unmarshals a slice of ListEnterpriseResources instances that are stored as a property
// within the specified map.
func UnmarshalListEnterpriseResourcesSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListEnterpriseResources, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListEnterpriseResources'", propertyName)
			return
		}
		slice, err = UnmarshalListEnterpriseResourcesSlice(vSlice)
	}
	return
}
...
// UnmarshalListEnterprisesResponse constructs an instance of ListEnterprisesResponse from the specified map.
func UnmarshalListEnterprisesResponse(m map[string]interface{}) (result *ListEnterprisesResponse, err error) {
	...
	obj.Resources, err = UnmarshalListEnterpriseResourcesSliceAsProperty(m, "resources")
	if err != nil {
		return
	}
	result = obj
...
// UnmarshalListEnterprisesResponseSlice unmarshals a slice of ListEnterprisesResponse instances from the specified list of maps.
func UnmarshalListEnterprisesResponseSlice(s []interface{}) (slice []ListEnterprisesResponse, err error) {
	for _, v := range s {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("slice element should be a map containing an instance of 'ListEnterprisesResponse'")
			return
		}
		obj, e := UnmarshalListEnterprisesResponse(objMap)
		if e != nil {
			err = e
			return
		}
...
// UnmarshalListEnterprisesResponseAsProperty unmarshals an instance of ListEnterprisesResponse that is stored as a property
// within the specified map.
func UnmarshalListEnterprisesResponseAsProperty(m map[string]interface{}, propertyName string) (result *ListEnterprisesResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		objMap, ok := v.(map[string]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a map containing an instance of 'ListEnterprisesResponse'", propertyName)
			return
		}
		result, err = UnmarshalListEnterprisesResponse(objMap)
	}
	return
}

// UnmarshalListEnterprisesResponseSliceAsProperty unmarshals a slice of ListEnterprisesResponse instances that are stored as a property
// within the specified map.
func UnmarshalListEnterprisesResponseSliceAsProperty(m map[string]interface{}, propertyName string) (slice []ListEnterprisesResponse, err error) {
	v, foundIt := m[propertyName]
	if foundIt {
		vSlice, ok := v.([]interface{})
		if !ok {
			err = fmt.Errorf("map property '%s' should be a slice of maps, each containing an instance of 'ListEnterprisesResponse'", propertyName)
			return
		}
		slice, err = UnmarshalListEnterprisesResponseSlice(vSlice)
	}
	return
}

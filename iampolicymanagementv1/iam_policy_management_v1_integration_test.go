...
var _ = Describe("IAM Policy Management - Integration Tests", func() {
	...
	Describe("Create a v2 access policy", func() {
		...
		It("Successfully created a v2 access policy", func() {
			...
			weeklyConditionAttribute := new(iampolicymanagementv1.RuleWithNestedConditionsConditionsItem)
			...
			startConditionAttribute := new(iampolicymanagementv1.RuleWithNestedConditionsConditionsItem)
			...
			endConditionAttribute := new(iampolicymanagementv1.RuleWithNestedConditionsConditionsItem)
			...
			policyRule.Conditions = []iampolicymanagementv1.RuleWithNestedConditionsConditionsItemIntf{weeklyConditionAttribute, startConditionAttribute, endConditionAttribute}
	...
	Describe("Update a v2 access policy", func() {
		...
		It("Successfully updated a v2 access policy", func() {
			...
			policyRule := new(iampolicymanagementv1.V2PolicyRule)
			policyRule.Operator = core.StringPtr("and")
			// ruleCondtions := make([]iampolicymanagementv1.RuleWithNestedConditionsConditionsItemIntf, 0)
			// ruleCondtions = append(ruleCondtions, endConditionAttribute)
			policyRule.Conditions = []iampolicymanagementv1.RuleWithNestedConditionsConditionsItemIntf{weeklyConditionAttribute, startConditionAttribute, endConditionAttribute}

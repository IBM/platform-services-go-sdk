...
var _ = Describe(`IamPolicyManagementV1`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"policy_templates": [{"name": "Name", "description": "Description", "account_id": "AccountID", "version": "Version", "committed": false, "policy": {"type": "access", "description": "Description", "resource": {"attributes": [{"key": "Key", "operator": "stringEquals", "value": "anyValue"}], "tags": [{"key": "Key", "value": "Value", "operator": "stringEquals"}]}, "pattern": "Pattern", "rule": {"key": "Key", "operator": "timeLessThan", "value": "anyValue"}}, "id": "ID", "href": "Href", "created_at": "2019-01-01T12:00:00.000Z", "created_by_id": "CreatedByID", "last_modified_at": "2019-01-01T12:00:00.000Z", "last_modified_by_id": "LastModifiedByID"}]}`)
				}))
			})
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"name": "Name", "description": "Description", "account_id": "AccountID", "version": "Version", "committed": false, "policy": {"type": "access", "description": "Description", "resource": {"attributes": [{"key": "Key", "operator": "stringEquals", "value": "anyValue"}], "tags": [{"key": "Key", "value": "Value", "operator": "stringEquals"}]}, "pattern": "Pattern", "rule": {"key": "Key", "operator": "timeLessThan", "value": "anyValue"}}, "id": "ID", "href": "Href", "created_at": "2019-01-01T12:00:00.000Z", "created_by_id": "CreatedByID", "last_modified_at": "2019-01-01T12:00:00.000Z", "last_modified_by_id": "LastModifiedByID"}`)
				}))
			})
	...
	Describe(`ListPolicyTemplateVerssions(listPolicyTemplateVerssionsOptions *ListPolicyTemplateVerssionsOptions) - Operation response error`, func() {
		listPolicyTemplateVerssionsPath := "/v1/policy_templates/testString/versions"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(listPolicyTemplateVerssionsPath))
					Expect(req.Method).To(Equal("GET"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke ListPolicyTemplateVerssions with error: Operation response processing error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the ListPolicyTemplateVerssionsOptions model
				listPolicyTemplateVerssionsOptionsModel := new(iampolicymanagementv1.ListPolicyTemplateVerssionsOptions)
				listPolicyTemplateVerssionsOptionsModel.PolicyTemplateID = core.StringPtr("testString")
				listPolicyTemplateVerssionsOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := iamPolicyManagementService.ListPolicyTemplateVerssions(listPolicyTemplateVerssionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListPolicyTemplateVerssions(listPolicyTemplateVerssionsOptions *ListPolicyTemplateVerssionsOptions)`, func() {
		listPolicyTemplateVerssionsPath := "/v1/policy_templates/testString/versions"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"versions": [{"name": "Name", "description": "Description", "account_id": "AccountID", "version": "Version", "committed": false, "policy": {"type": "access", "description": "Description", "resource": {"attributes": [{"key": "Key", "operator": "stringEquals", "value": "anyValue"}], "tags": [{"key": "Key", "value": "Value", "operator": "stringEquals"}]}, "pattern": "Pattern", "rule": {"key": "Key", "operator": "timeLessThan", "value": "anyValue"}}, "id": "ID", "href": "Href", "created_at": "2019-01-01T12:00:00.000Z", "created_by_id": "CreatedByID", "last_modified_at": "2019-01-01T12:00:00.000Z", "last_modified_by_id": "LastModifiedByID"}]}`)
				}))
			})
			It(`Invoke ListPolicyTemplateVerssions successfully with retries`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := iamPolicyManagementService.ListPolicyTemplateVerssionsWithContext(ctx, listPolicyTemplateVerssionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListPolicyTemplateVerssions successfully`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := iamPolicyManagementService.ListPolicyTemplateVerssions(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListPolicyTemplateVerssions with error: Operation validation and request error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the ListPolicyTemplateVerssionsOptions model with no property values
				listPolicyTemplateVerssionsOptionsModelNew := new(iampolicymanagementv1.ListPolicyTemplateVerssionsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = iamPolicyManagementService.ListPolicyTemplateVerssions(listPolicyTemplateVerssionsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CommitPolicyTemplate(commitPolicyTemplateOptions *CommitPolicyTemplateOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CommitPolicyTemplate with error: Operation response processing error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := iamPolicyManagementService.CommitPolicyTemplate(commitPolicyTemplateOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CommitPolicyTemplate(commitPolicyTemplateOptions *CommitPolicyTemplateOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CommitPolicyTemplate successfully with retries`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := iamPolicyManagementService.CommitPolicyTemplateWithContext(ctx, commitPolicyTemplateOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CommitPolicyTemplate successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := iamPolicyManagementService.CommitPolicyTemplate(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CommitPolicyTemplate with error: Operation validation and request error`, func() {
				...
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = iamPolicyManagementService.CommitPolicyTemplate(commitPolicyTemplateOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"assignments": [{"template_id": "TemplateID", "template_version": "TemplateVersion", "root_assignment_id": "RootAssignmentID", "target_type": "account", "target": "Target", "id": "ID", "href": "Href", "created_at": "2019-01-01T12:00:00.000Z", "created_by_id": "CreatedByID", "last_modified_at": "2019-01-01T12:00:00.000Z", "last_modified_by_id": "LastModifiedByID", "resources": [{"target": "Target", "policy": {"resource_created": {"id": "ID"}, "error_message": {"trace": "Trace", "errors": [{"code": "insufficent_permissions", "message": "Message", "details": {"conflicts_with": {"etag": "Etag", "role": "Role", "policy": "Policy"}}, "more_info": "MoreInfo"}], "status_code": 10}, "status": "in_progress"}}]}]}`)
				}))
			})
	...
	Describe(`CreatePolicyTemplateAssignment(createPolicyTemplateAssignmentOptions *CreatePolicyTemplateAssignmentOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreatePolicyTemplateAssignment with error: Operation response processing error`, func() {
				...
				// Construct an instance of the PolicyAssignmentOptions model
				policyAssignmentOptionsModel := new(iampolicymanagementv1.PolicyAssignmentOptions)
				policyAssignmentOptionsModel.SubjectType = core.StringPtr("iam_id")
				policyAssignmentOptionsModel.SubjectID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootRequesterID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootTemplateID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootTemplateVersion = core.StringPtr("testString")
				...
				createPolicyTemplateAssignmentOptionsModel.TemplateID = core.StringPtr("testString")
				createPolicyTemplateAssignmentOptionsModel.TemplateVersion = core.StringPtr("testString")
				createPolicyTemplateAssignmentOptionsModel.RootAssignmentID = core.StringPtr("testString")
				createPolicyTemplateAssignmentOptionsModel.TargetType = core.StringPtr("account")
				createPolicyTemplateAssignmentOptionsModel.Target = core.StringPtr("testString")
				createPolicyTemplateAssignmentOptionsModel.Options = policyAssignmentOptionsModel
	...
	Describe(`CreatePolicyTemplateAssignment(createPolicyTemplateAssignmentOptions *CreatePolicyTemplateAssignmentOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreatePolicyTemplateAssignment with error: Operation request error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`PatchPolicyAssignment(patchPolicyAssignmentOptions *PatchPolicyAssignmentOptions) - Operation response error`, func() {
		patchPolicyAssignmentPath := "/v1/policy_assignments/testString"
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					defer GinkgoRecover()
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(patchPolicyAssignmentPath))
					Expect(req.Method).To(Equal("PATCH"))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprint(res, `} this is not valid json {`)
			...
			It(`Invoke PatchPolicyAssignment with error: Operation response processing error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Construct an instance of the PatchPolicyAssignmentOptions model
				patchPolicyAssignmentOptionsModel := new(iampolicymanagementv1.PatchPolicyAssignmentOptions)
				patchPolicyAssignmentOptionsModel.AssignmentID = core.StringPtr("testString")
				patchPolicyAssignmentOptionsModel.Version = core.StringPtr("testString")
				patchPolicyAssignmentOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := iamPolicyManagementService.PatchPolicyAssignment(patchPolicyAssignmentOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`PatchPolicyAssignment(patchPolicyAssignmentOptions *PatchPolicyAssignmentOptions)`, func() {
		patchPolicyAssignmentPath := "/v1/policy_assignments/testString"
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
			...
			It(`Invoke PatchPolicyAssignment successfully with retries`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := iamPolicyManagementService.PatchPolicyAssignmentWithContext(ctx, patchPolicyAssignmentOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke PatchPolicyAssignment successfully`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := iamPolicyManagementService.PatchPolicyAssignment(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke PatchPolicyAssignment with error: Operation validation and request error`, func() {
				iamPolicyManagementService, serviceErr := iampolicymanagementv1.NewIamPolicyManagementV1(&iampolicymanagementv1.IamPolicyManagementV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the PatchPolicyAssignmentOptions model with no property values
				patchPolicyAssignmentOptionsModelNew := new(iampolicymanagementv1.PatchPolicyAssignmentOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = iamPolicyManagementService.PatchPolicyAssignment(patchPolicyAssignmentOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreatePolicyTemplateAssignmentOptions successfully`, func() {
				// Construct an instance of the PolicyAssignmentOptions model
				policyAssignmentOptionsModel := new(iampolicymanagementv1.PolicyAssignmentOptions)
				Expect(policyAssignmentOptionsModel).ToNot(BeNil())
				policyAssignmentOptionsModel.SubjectType = core.StringPtr("iam_id")
				policyAssignmentOptionsModel.SubjectID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootRequesterID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootTemplateID = core.StringPtr("testString")
				policyAssignmentOptionsModel.RootTemplateVersion = core.StringPtr("testString")
				Expect(policyAssignmentOptionsModel.SubjectType).To(Equal(core.StringPtr("iam_id")))
				Expect(policyAssignmentOptionsModel.SubjectID).To(Equal(core.StringPtr("testString")))
				Expect(policyAssignmentOptionsModel.RootRequesterID).To(Equal(core.StringPtr("testString")))
				Expect(policyAssignmentOptionsModel.RootTemplateID).To(Equal(core.StringPtr("testString")))
				Expect(policyAssignmentOptionsModel.RootTemplateVersion).To(Equal(core.StringPtr("testString")))

				// Construct an instance of the CreatePolicyTemplateAssignmentOptions model
				createPolicyTemplateAssignmentOptionsModel := iamPolicyManagementService.NewCreatePolicyTemplateAssignmentOptions()
				createPolicyTemplateAssignmentOptionsModel.SetTemplateID("testString")
				createPolicyTemplateAssignmentOptionsModel.SetTemplateVersion("testString")
				createPolicyTemplateAssignmentOptionsModel.SetRootAssignmentID("testString")
				createPolicyTemplateAssignmentOptionsModel.SetTargetType("account")
				createPolicyTemplateAssignmentOptionsModel.SetTarget("testString")
				createPolicyTemplateAssignmentOptionsModel.SetOptions(policyAssignmentOptionsModel)
				...
				Expect(createPolicyTemplateAssignmentOptionsModel.TemplateID).To(Equal(core.StringPtr("testString")))
				Expect(createPolicyTemplateAssignmentOptionsModel.TemplateVersion).To(Equal(core.StringPtr("testString")))
				Expect(createPolicyTemplateAssignmentOptionsModel.RootAssignmentID).To(Equal(core.StringPtr("testString")))
				Expect(createPolicyTemplateAssignmentOptionsModel.TargetType).To(Equal(core.StringPtr("account")))
				Expect(createPolicyTemplateAssignmentOptionsModel.Target).To(Equal(core.StringPtr("testString")))
				Expect(createPolicyTemplateAssignmentOptionsModel.Options).To(Equal(policyAssignmentOptionsModel))
			...
			It(`Invoke NewCreatePolicyTemplateVersionOptions successfully`, func() {
				...
				// Construct an instance of the CreatePolicyTemplateVersionOptions model
				policyTemplateID := "testString"
				createPolicyTemplateVersionOptionsName := "testString"
				var createPolicyTemplateVersionOptionsPolicy *iampolicymanagementv1.TemplatePolicy = nil
				createPolicyTemplateVersionOptionsModel := iamPolicyManagementService.NewCreatePolicyTemplateVersionOptions(policyTemplateID, createPolicyTemplateVersionOptionsName, createPolicyTemplateVersionOptionsPolicy)
			...
			It(`Invoke NewListPolicyTemplateVerssionsOptions successfully`, func() {
				// Construct an instance of the ListPolicyTemplateVerssionsOptions model
				policyTemplateID := "testString"
				listPolicyTemplateVerssionsOptionsModel := iamPolicyManagementService.NewListPolicyTemplateVerssionsOptions(policyTemplateID)
				listPolicyTemplateVerssionsOptionsModel.SetPolicyTemplateID("testString")
				listPolicyTemplateVerssionsOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(listPolicyTemplateVerssionsOptionsModel).ToNot(BeNil())
				Expect(listPolicyTemplateVerssionsOptionsModel.PolicyTemplateID).To(Equal(core.StringPtr("testString")))
				Expect(listPolicyTemplateVerssionsOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewPatchPolicyAssignmentOptions successfully`, func() {
				// Construct an instance of the PatchPolicyAssignmentOptions model
				assignmentID := "testString"
				patchPolicyAssignmentOptionsVersion := "testString"
				patchPolicyAssignmentOptionsModel := iamPolicyManagementService.NewPatchPolicyAssignmentOptions(assignmentID, patchPolicyAssignmentOptionsVersion)
				patchPolicyAssignmentOptionsModel.SetAssignmentID("testString")
				patchPolicyAssignmentOptionsModel.SetVersion("testString")
				patchPolicyAssignmentOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(patchPolicyAssignmentOptionsModel).ToNot(BeNil())
				Expect(patchPolicyAssignmentOptionsModel.AssignmentID).To(Equal(core.StringPtr("testString")))
				Expect(patchPolicyAssignmentOptionsModel.Version).To(Equal(core.StringPtr("testString")))
				Expect(patchPolicyAssignmentOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewPolicyAssignmentOptions successfully`, func() {
				subjectType := "iam_id"
				subjectID := "testString"
				rootRequesterID := "testString"
				_model, err := iamPolicyManagementService.NewPolicyAssignmentOptions(subjectType, subjectID, rootRequesterID)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			...
			It(`Invoke NewReplacePolicyTemplateOptions successfully`, func() {
				...
				version := "testString"
				ifMatch := "testString"
				replacePolicyTemplateOptionsName := "testString"
				var replacePolicyTemplateOptionsPolicy *iampolicymanagementv1.TemplatePolicy = nil
				replacePolicyTemplateOptionsModel := iamPolicyManagementService.NewReplacePolicyTemplateOptions(policyTemplateID, version, ifMatch, replacePolicyTemplateOptionsName, replacePolicyTemplateOptionsPolicy)

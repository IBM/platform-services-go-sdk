...
// ListPolicyTemplates : Get policy templates by attributes
...
// GetPolicyTemplate : Retrieve latest policy template version by template ID
...
// DeletePolicyTemplate : Delete a policy template by ID
...
// ListPolicyTemplateVerssions : Retrieve policy template versions
// Retrieve the versions of a policy template by providing a policy template ID.
func (iamPolicyManagement *IamPolicyManagementV1) ListPolicyTemplateVerssions(listPolicyTemplateVerssionsOptions *ListPolicyTemplateVerssionsOptions) (result *PolicyTemplateVersionsCollection, response *core.DetailedResponse, err error) {
	return iamPolicyManagement.ListPolicyTemplateVerssionsWithContext(context.Background(), listPolicyTemplateVerssionsOptions)
}

// ListPolicyTemplateVerssionsWithContext is an alternate form of the ListPolicyTemplateVerssions method which supports a Context parameter
func (iamPolicyManagement *IamPolicyManagementV1) ListPolicyTemplateVerssionsWithContext(ctx context.Context, listPolicyTemplateVerssionsOptions *ListPolicyTemplateVerssionsOptions) (result *PolicyTemplateVersionsCollection, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(listPolicyTemplateVerssionsOptions, "listPolicyTemplateVerssionsOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(listPolicyTemplateVerssionsOptions, "listPolicyTemplateVerssionsOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"policy_template_id": *listPolicyTemplateVerssionsOptions.PolicyTemplateID,
	}
	...
	for headerName, headerValue := range listPolicyTemplateVerssionsOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_policy_management", "V1", "ListPolicyTemplateVerssions")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
...
// DeletePolicyTemplateVersion : Delete a policy template version by ID and version
...
// GetPolicyTemplateVersion : Retrieve a policy template version by ID
...
func (iamPolicyManagement *IamPolicyManagementV1) CommitPolicyTemplate(commitPolicyTemplateOptions *CommitPolicyTemplateOptions) (result *PolicyTemplate, response *core.DetailedResponse, err error) {
...
func (iamPolicyManagement *IamPolicyManagementV1) CommitPolicyTemplateWithContext(ctx context.Context, commitPolicyTemplateOptions *CommitPolicyTemplateOptions) (result *PolicyTemplate, response *core.DetailedResponse, err error) {
...
// ListPolicyAssignments : Get policies template assignments by attributes
...
// specified attributes and that the caller has read access to are returned. If the caller does not have read access to
// any policy template assignments an empty array is returned.
func (iamPolicyManagement *IamPolicyManagementV1) ListPolicyAssignments(listPolicyAssignmentsOptions *ListPolicyAssignmentsOptions) (result *PolcyTemplateAssignmentCollection, response *core.DetailedResponse, err error) {
...
func (iamPolicyManagement *IamPolicyManagementV1) ListPolicyAssignmentsWithContext(ctx context.Context, listPolicyAssignmentsOptions *ListPolicyAssignmentsOptions) (result *PolcyTemplateAssignmentCollection, response *core.DetailedResponse, err error) {
	...
	if rawResponse != nil {
		err = core.UnmarshalModel(rawResponse, "", &result, UnmarshalPolcyTemplateAssignmentCollection)
		if err != nil {
			return
		}
		response.Result = result
...
// CreatePolicyTemplateAssignment : Create a policy template assignment
// Assign a policy template.
func (iamPolicyManagement *IamPolicyManagementV1) CreatePolicyTemplateAssignment(createPolicyTemplateAssignmentOptions *CreatePolicyTemplateAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
...
func (iamPolicyManagement *IamPolicyManagementV1) CreatePolicyTemplateAssignmentWithContext(ctx context.Context, createPolicyTemplateAssignmentOptions *CreatePolicyTemplateAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
	...
	body := make(map[string]interface{})
	if createPolicyTemplateAssignmentOptions.TemplateID != nil {
		body["template_id"] = createPolicyTemplateAssignmentOptions.TemplateID
	}
	if createPolicyTemplateAssignmentOptions.TemplateVersion != nil {
		body["template_version"] = createPolicyTemplateAssignmentOptions.TemplateVersion
	}
	if createPolicyTemplateAssignmentOptions.RootAssignmentID != nil {
		body["root_assignment_id"] = createPolicyTemplateAssignmentOptions.RootAssignmentID
	}
	if createPolicyTemplateAssignmentOptions.TargetType != nil {
		body["target_type"] = createPolicyTemplateAssignmentOptions.TargetType
	}
	...
	if rawResponse != nil {
		err = core.UnmarshalModel(rawResponse, "", &result, UnmarshalPolicyAssignmentRecord)
		if err != nil {
			return
		}
		response.Result = result
...
// GetPolicyAssignment : Retrieve a policy assignment by ID
// Retrieve a policy template assignment by providing a policy assignment ID.
func (iamPolicyManagement *IamPolicyManagementV1) GetPolicyAssignment(getPolicyAssignmentOptions *GetPolicyAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
...
func (iamPolicyManagement *IamPolicyManagementV1) GetPolicyAssignmentWithContext(ctx context.Context, getPolicyAssignmentOptions *GetPolicyAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
...
// PatchPolicyAssignment : Update a policy assignment by ID
// Update a policy assignment by providing a policy assignment ID.
func (iamPolicyManagement *IamPolicyManagementV1) PatchPolicyAssignment(patchPolicyAssignmentOptions *PatchPolicyAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
	return iamPolicyManagement.PatchPolicyAssignmentWithContext(context.Background(), patchPolicyAssignmentOptions)
}

// PatchPolicyAssignmentWithContext is an alternate form of the PatchPolicyAssignment method which supports a Context parameter
func (iamPolicyManagement *IamPolicyManagementV1) PatchPolicyAssignmentWithContext(ctx context.Context, patchPolicyAssignmentOptions *PatchPolicyAssignmentOptions) (result *PolicyAssignmentRecord, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(patchPolicyAssignmentOptions, "patchPolicyAssignmentOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(patchPolicyAssignmentOptions, "patchPolicyAssignmentOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"assignment_id": *patchPolicyAssignmentOptions.AssignmentID,
	}
	...
	for headerName, headerValue := range patchPolicyAssignmentOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("iam_policy_management", "V1", "PatchPolicyAssignment")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	...
	body := make(map[string]interface{})
	if patchPolicyAssignmentOptions.Version != nil {
		body["version"] = patchPolicyAssignmentOptions.Version
	}
	_, err = builder.SetBodyContentJSON(body)
	if err != nil {
		return
...
// DeletePolicyAssignment : Remove a policy assignment by ID
// Remove a policy template assignment by providing a policy assignment ID. A policy assignment cannot be deleted if the
...
type CreatePolicyTemplateAssignmentOptions struct {
	...
	RootAssignmentID *string `json:"root_assignment_id,omitempty"`
...
// Constants associated with the CreatePolicyTemplateAssignmentOptions.TargetType property.
// Assignment target type.
const (
	CreatePolicyTemplateAssignmentOptionsTargetTypeAccountConst = "account"
	CreatePolicyTemplateAssignmentOptionsTargetTypeAccountgroupConst = "accountGroup"
	CreatePolicyTemplateAssignmentOptionsTargetTypeEnterpriseConst = "enterprise"
)

// NewCreatePolicyTemplateAssignmentOptions : Instantiate CreatePolicyTemplateAssignmentOptions
func (*IamPolicyManagementV1) NewCreatePolicyTemplateAssignmentOptions() *CreatePolicyTemplateAssignmentOptions {
	return &CreatePolicyTemplateAssignmentOptions{}
}

// SetTemplateID : Allow user to set TemplateID
func (_options *CreatePolicyTemplateAssignmentOptions) SetTemplateID(templateID string) *CreatePolicyTemplateAssignmentOptions {
	_options.TemplateID = core.StringPtr(templateID)
	return _options
}

// SetTemplateVersion : Allow user to set TemplateVersion
func (_options *CreatePolicyTemplateAssignmentOptions) SetTemplateVersion(templateVersion string) *CreatePolicyTemplateAssignmentOptions {
	_options.TemplateVersion = core.StringPtr(templateVersion)
	return _options
}

// SetRootAssignmentID : Allow user to set RootAssignmentID
func (_options *CreatePolicyTemplateAssignmentOptions) SetRootAssignmentID(rootAssignmentID string) *CreatePolicyTemplateAssignmentOptions {
	_options.RootAssignmentID = core.StringPtr(rootAssignmentID)
	return _options
}

// SetTargetType : Allow user to set TargetType
func (_options *CreatePolicyTemplateAssignmentOptions) SetTargetType(targetType string) *CreatePolicyTemplateAssignmentOptions {
	_options.TargetType = core.StringPtr(targetType)
	return _options
}

// SetTarget : Allow user to set Target
func (_options *CreatePolicyTemplateAssignmentOptions) SetTarget(target string) *CreatePolicyTemplateAssignmentOptions {
	_options.Target = core.StringPtr(target)
	return _options
}

// SetOptions : Allow user to set Options
func (_options *CreatePolicyTemplateAssignmentOptions) SetOptions(options *PolicyAssignmentOptions) *CreatePolicyTemplateAssignmentOptions {
...
func (*IamPolicyManagementV1) NewCreatePolicyTemplateVersionOptions(policyTemplateID string, name string, policy *TemplatePolicy) *CreatePolicyTemplateVersionOptions {
...
// ListPolicyTemplateVerssionsOptions : The ListPolicyTemplateVerssions options.
type ListPolicyTemplateVerssionsOptions struct {
	// The policy template ID.
	PolicyTemplateID *string `json:"policy_template_id" validate:"required,ne="`
...
// NewListPolicyTemplateVerssionsOptions : Instantiate ListPolicyTemplateVerssionsOptions
func (*IamPolicyManagementV1) NewListPolicyTemplateVerssionsOptions(policyTemplateID string) *ListPolicyTemplateVerssionsOptions {
	return &ListPolicyTemplateVerssionsOptions{
		PolicyTemplateID: core.StringPtr(policyTemplateID),
	}
}

// SetPolicyTemplateID : Allow user to set PolicyTemplateID
func (_options *ListPolicyTemplateVerssionsOptions) SetPolicyTemplateID(policyTemplateID string) *ListPolicyTemplateVerssionsOptions {
	_options.PolicyTemplateID = core.StringPtr(policyTemplateID)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *ListPolicyTemplateVerssionsOptions) SetHeaders(param map[string]string) *ListPolicyTemplateVerssionsOptions {
	options.Headers = param
	return options
}
...
// PatchPolicyAssignmentOptions : The PatchPolicyAssignment options.
type PatchPolicyAssignmentOptions struct {
	// The policy template assignment ID.
	AssignmentID *string `json:"assignment_id" validate:"required,ne="`
...
// NewPatchPolicyAssignmentOptions : Instantiate PatchPolicyAssignmentOptions
func (*IamPolicyManagementV1) NewPatchPolicyAssignmentOptions(assignmentID string, version string) *PatchPolicyAssignmentOptions {
	return &PatchPolicyAssignmentOptions{
		AssignmentID: core.StringPtr(assignmentID),
		Version: core.StringPtr(version),
	}
}
...
// SetAssignmentID : Allow user to set AssignmentID
func (_options *PatchPolicyAssignmentOptions) SetAssignmentID(assignmentID string) *PatchPolicyAssignmentOptions {
	_options.AssignmentID = core.StringPtr(assignmentID)
	return _options
}

// SetVersion : Allow user to set Version
func (_options *PatchPolicyAssignmentOptions) SetVersion(version string) *PatchPolicyAssignmentOptions {
	_options.Version = core.StringPtr(version)
	return _options
}

// SetHeaders : Allow user to set Headers
func (options *PatchPolicyAssignmentOptions) SetHeaders(param map[string]string) *PatchPolicyAssignmentOptions {
	options.Headers = param
	return options
}
...
// NewPolicyAssignmentOptions : Instantiate PolicyAssignmentOptions (Generic Model Constructor)
func (*IamPolicyManagementV1) NewPolicyAssignmentOptions(subjectType string, subjectID string, rootRequesterID string) (_model *PolicyAssignmentOptions, err error) {
	_model = &PolicyAssignmentOptions{
		SubjectType: core.StringPtr(subjectType),
		SubjectID: core.StringPtr(subjectID),
		RootRequesterID: core.StringPtr(rootRequesterID),
	}
	err = core.ValidateStruct(_model, "required parameters")
	return
}
...
const (
	...
	PolicyAssignmentRecordTargetTypeAccountgroupConst = "accountGroup"
	PolicyAssignmentRecordTargetTypeEnterpriseConst = "enterprise"
)

// UnmarshalPolicyAssignmentRecord unmarshals an instance of PolicyAssignmentRecord from the specified map of raw messages.
func UnmarshalPolicyAssignmentRecord(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(PolicyAssignmentRecord)
	...
	err = core.UnmarshalPrimitive(m, "root_assignment_id", &obj.RootAssignmentID)
	if err != nil {
		return
	}
...
// PolicyTemplateVersionsCollection : A collection of policy Template versions.
...
func (*IamPolicyManagementV1) NewReplacePolicyTemplateOptions(policyTemplateID string, version string, ifMatch string, name string, policy *TemplatePolicy) *ReplacePolicyTemplateOptions {
...
// TemplateMetada : Origin Template information.
type TemplateMetada struct {
	// Origin Template CRN.
...
// UnmarshalTemplateMetada unmarshals an instance of TemplateMetada from the specified map of raw messages.
func UnmarshalTemplateMetada(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(TemplateMetada)
...
type V2Policy struct {
	...
	Template *TemplateMetada `json:"template,omitempty"`
}
...
func UnmarshalV2Policy(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "template", &obj.Template, UnmarshalTemplateMetada)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))

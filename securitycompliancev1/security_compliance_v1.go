...
// Package securitycompliancev1 : Operations and models for the SecurityComplianceV1 service
package securitycompliancev1
...
// SecurityComplianceV1 : With IBM Cloud® Security and Compliance Center, you can embed checks into your every day
...
//
// Version: 1.0.0
type SecurityComplianceV1 struct {
	Service *core.BaseService
}

// DefaultServiceName is the default key used to find external configuration information.
const DefaultServiceName = "security_compliance"

// SecurityComplianceV1Options : Service options
type SecurityComplianceV1Options struct {
	ServiceName   string
	URL           string
	Authenticator core.Authenticator
}

// NewSecurityComplianceV1UsingExternalConfig : constructs an instance of SecurityComplianceV1 with passed in options and external configuration.
func NewSecurityComplianceV1UsingExternalConfig(options *SecurityComplianceV1Options) (securityCompliance *SecurityComplianceV1, err error) {
	...
	securityCompliance, err = NewSecurityComplianceV1(options)
	if err != nil {
		return
	}

	err = securityCompliance.Service.ConfigureService(options.ServiceName)
	if err != nil {
		return
	}

	if options.URL != "" {
		err = securityCompliance.Service.SetServiceURL(options.URL)
	}
	return
}

// NewSecurityComplianceV1 : constructs an instance of SecurityComplianceV1 with passed in options.
func NewSecurityComplianceV1(options *SecurityComplianceV1Options) (service *SecurityComplianceV1, err error) {
...
// Clone makes a copy of "securityCompliance" suitable for processing requests.
func (securityCompliance *SecurityComplianceV1) Clone() *SecurityComplianceV1 {
	if core.IsNil(securityCompliance) {
		return nil
	}
	clone := *securityCompliance
	clone.Service = securityCompliance.Service.Clone()
	return &clone
}

// SetServiceURL sets the service URL
func (securityCompliance *SecurityComplianceV1) SetServiceURL(url string) error {
	return securityCompliance.Service.SetServiceURL(url)
}

// GetServiceURL returns the service URL
func (securityCompliance *SecurityComplianceV1) GetServiceURL() string {
	return securityCompliance.Service.GetServiceURL()
}

// SetDefaultHeaders sets HTTP headers to be sent in every request
func (securityCompliance *SecurityComplianceV1) SetDefaultHeaders(headers http.Header) {
	securityCompliance.Service.SetDefaultHeaders(headers)
}

// SetEnableGzipCompression sets the service's EnableGzipCompression field
func (securityCompliance *SecurityComplianceV1) SetEnableGzipCompression(enableGzip bool) {
	securityCompliance.Service.SetEnableGzipCompression(enableGzip)
}

// GetEnableGzipCompression returns the service's EnableGzipCompression field
func (securityCompliance *SecurityComplianceV1) GetEnableGzipCompression() bool {
	return securityCompliance.Service.GetEnableGzipCompression()
}

// EnableRetries enables automatic retries for requests invoked for this service instance.
// If either parameter is specified as 0, then a default value is used instead.
func (securityCompliance *SecurityComplianceV1) EnableRetries(maxRetries int, maxRetryInterval time.Duration) {
	securityCompliance.Service.EnableRetries(maxRetries, maxRetryInterval)
}

// DisableRetries disables automatic retries for requests invoked for this service instance.
func (securityCompliance *SecurityComplianceV1) DisableRetries() {
	securityCompliance.Service.DisableRetries()
}
...
func (securityCompliance *SecurityComplianceV1) CreateValidationScan(createValidationScanOptions *CreateValidationScanOptions) (result *Result, response *core.DetailedResponse, err error) {
	return securityCompliance.CreateValidationScanWithContext(context.Background(), createValidationScanOptions)
}
...
func (securityCompliance *SecurityComplianceV1) CreateValidationScanWithContext(ctx context.Context, createValidationScanOptions *CreateValidationScanOptions) (result *Result, response *core.DetailedResponse, err error) {
	...
	builder.EnableGzipCompression = securityCompliance.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(securityCompliance.Service.Options.URL, `/posture/v1/scans/validation`, nil)
	if err != nil {
		return
	}
	...
	sdkHeaders := common.GetSdkHeaders("security_compliance", "V1", "CreateValidationScan")
	...
	response, err = securityCompliance.Service.Request(request, &rawResponse)
	if err != nil {
		return
	}
...
func (securityCompliance *SecurityComplianceV1) ListProfile(listProfileOptions *ListProfileOptions) (result *ProfilesList, response *core.DetailedResponse, err error) {
	return securityCompliance.ListProfileWithContext(context.Background(), listProfileOptions)
}

// ListProfileWithContext is an alternate form of the ListProfile method which supports a Context parameter
func (securityCompliance *SecurityComplianceV1) ListProfileWithContext(ctx context.Context, listProfileOptions *ListProfileOptions) (result *ProfilesList, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = securityCompliance.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(securityCompliance.Service.Options.URL, `/posture/v1/profiles`, nil)
	if err != nil {
		return
	}
	...
	sdkHeaders := common.GetSdkHeaders("security_compliance", "V1", "ListProfile")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
...
func (securityCompliance *SecurityComplianceV1) ListScopes(listScopesOptions *ListScopesOptions) (result *ScopesList, response *core.DetailedResponse, err error) {
	return securityCompliance.ListScopesWithContext(context.Background(), listScopesOptions)
}

// ListScopesWithContext is an alternate form of the ListScopes method which supports a Context parameter
func (securityCompliance *SecurityComplianceV1) ListScopesWithContext(ctx context.Context, listScopesOptions *ListScopesOptions) (result *ScopesList, response *core.DetailedResponse, err error) {
	...
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = securityCompliance.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(securityCompliance.Service.Options.URL, `/posture/v1/scopes`, nil)
	if err != nil {
		return
	}
	...
	sdkHeaders := common.GetSdkHeaders("security_compliance", "V1", "ListScopes")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
...
func (*SecurityComplianceV1) NewCreateValidationScanOptions(accountID string) *CreateValidationScanOptions {
...
func (*SecurityComplianceV1) NewListProfileOptions(accountID string) *ListProfileOptions {
...
func (*SecurityComplianceV1) NewListScopesOptions(accountID string) *ListScopesOptions {
